...
class GameController:
  ...
  def getValidMovesOfAllPiecesWith(self, gs:GameState, isEndangered: bool = False) -> Action:
    """
  ...
  def isTerminal(self, gs:GameState) -> bool:
    ...
    for _ in self.getValidMovesOfAllPiecesWith(gs, isEndangered):
      return False
    return True
